...
/////////////////////////////////////////////////////////////////////
//MFRC522
sbit     MF522_RST  =    P2^7;//4                   //RC500片选
sbit     MF522_NSS  =    P2^2;//2
sbit     MF522_SCK  =    P2^4;//1
sbit     MF522_SI   =    P2^5;//0
sbit     MF522_SO   =    P2^6;//3
/////////////////////////////////////////////////////////////////////
//函数原型
/////////////////////////////////////////////////////////////////////
...
unsigned char ReadRawRC(unsigned char Address);//读RC522寄存器
...
void PcdInit(void);//初始化RC522
                 
//课题需要的非常规代码                 
unsigned char RC522_FindCard(unsigned char * g_ucTempbuf,unsigned char Picc_Authent,unsigned char Data_Block,unsigned char * Password);//寻找特定卡密的寻卡程序
